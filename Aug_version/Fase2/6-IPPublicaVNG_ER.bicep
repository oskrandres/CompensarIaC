...
param publicIPAddresses_ip_GWSubnet_transversal_ER_name string = 'pip-vgw-netwrk-centrl-exprte-trv-i'

resource publicIP 'Microsoft.Network/publicIPAddresses@2024-05-01' = {
  name: publicIPAddresses_ip_GWSubnet_transversal_ER_name
  location: location
  sku: {
    name: 'Standard'
    tier: 'Regional'
